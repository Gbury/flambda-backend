...
val name :
  ...
  To_cmm_result.t ->
  Name.t ->
  Cmm.expression * Backend_var.Set.t * To_cmm_env.t * To_cmm_result.t * Effects_and_coeffects.t
...
val simple_list :
  ...
  To_cmm_result.t ->
  Simple.t list ->
  Cmm.expression list * Backend_var.Set.t * To_cmm_env.t * To_cmm_result.t * Effects_and_coeffects.t
